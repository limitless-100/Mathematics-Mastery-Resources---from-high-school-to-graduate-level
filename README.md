...
* [Introduction to Mathematical Thinking](https://www.coursera.org/learn/mathematical-thinking) - A popular Coursera course by _Dr. Keith Kelvin_ from Stanford University.
* Proofs [_by Jay Cummings_] - Very intuitive and fun!
...
It's simple using the internet. See an example: "Prerequisites of functional analysis AAA" on any search engine. AAA should be replaced with Reddit, Quora, Math stack exchange or Math oveflow. In addition, you should always read the _**preface**_ of any mathematics book you are studying.
...
[Open-Source Softwares for Mathematics](https://en.wikipedia.org/wiki/List_of_open-source_software_for_mathematics) contains a list of free mathematics software packages you can install on your computer devices to aid your learning. 
